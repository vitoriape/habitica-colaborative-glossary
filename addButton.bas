...
'<2>Realiza o cadastro das informações
    ActiveCell.Value = Range("Add_New_Discussion!B2") 'PT-BR
    
    ActiveCell.Offset(0, 1).Select
    ActiveCell.Value = Range("Add_New_Discussion!B3") 'EN
    
    ActiveCell.Offset(0, 1).Select
    ActiveCell.Value = Range("Add_New_Discussion!B5") 'LABEL
    
    ActiveCell.Offset(0, 1).Select
    ActiveCell.Value = Range("Add_New_Discussion!B6") 'NOTES
